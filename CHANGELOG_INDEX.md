...
**Generated** by `tools/changelog_index.py` from the 467 dated entries in `CHANGELOG.md`. Do not edit by hand: regenerate. `docs_test` § 7 only compares the entry COUNT, so a stale hook or a wrong anchor here passes it — regenerate after every CHANGELOG edit.
...
| [Storage — SCSI, IWM, SWIM, media](#storage--scsi-iwm-swim-media) | 62 |
...
- **2026-09-08** — [Floppy 1.44 MB: the reg-14 lead is a red herring — POM68K matches MAME at every control decision; the difference is the read DATA](CHANGELOG.md#2026-09-08-floppy-ism-vs-iwm)
