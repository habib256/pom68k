...
**Generated** by `tools/changelog_index.py` from the 460 dated entries in `CHANGELOG.md`. Do not edit by hand: regenerate. `docs_test` § 7 only compares the entry COUNT, so a stale hook or a wrong anchor here passes it — regenerate after every CHANGELOG edit.
...
| [Storage — SCSI, IWM, SWIM, media](#storage--scsi-iwm-swim-media) | 55 |
...
| [Cross-cutting](#cross-cutting) | 88 |
...
- **2026-09-08** — [Floppy 1.44 MB: a MAME co-trace overturns the ACTION theory — the real LC II reads MFM via the IWM (software), never arming ISM ACTION](CHANGELOG.md#2026-09-08-floppy-ism-vs-iwm)
