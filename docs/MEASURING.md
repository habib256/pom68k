...
The AArch64 row was 2 permille, the Apple M1's null experiment of 2026-08-22
...
measurement it bars (`CHANGELOG.md` 2026-08-22 (third)). It now records 11
permille, re-measured on the M4 when both of that host's nulls failed the
policy check against the M1's figure (`CHANGELOG.md` 2026-09-03). Re-measure
on any other ARM host before trusting it there.
