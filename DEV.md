...
| Discrete 040 + DAFB | **Quadra 700** | Quadra 900/950 ("Eclipse": the same board plus the two IOPs — `Q700Memory::Model`; POSTs, boot still open) | [2.8](#28-discrete-040--dafb--quadra-700) |
...
136 gates / ~2h30, and `ctest -j` is unsafe because the boot etalons are
