...
- **Every platform is GUI-complete**: 12 memory maps, 37 `kProfiles` rows,
  ...
  power-flag scrub), not a discrete RTC. Still open on it, in milestone order:
  input through the PMU, then the sleep/wake gate no other machine can test
