...
| What changed and **why** — dated entries, the project's real design record | `CHANGELOG.md` (216 entries; **everything that happened to one subsystem** → `CHANGELOG_INDEX.md`, generated by `tools/changelog_index.py`) |
...
ctest                        # 183 gates, ~4h (asset-dependent ones soft-skip)
...
23 patch groups, 361 marked lines, 55 `pom*` hooks — a re-sync would be a port,
