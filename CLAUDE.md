...
| What changed and **why** — dated entries, the project's real design record | `CHANGELOG.md` (222 entries; **everything that happened to one subsystem** → `CHANGELOG_INDEX.md`, generated by `tools/changelog_index.py`) |
...
- **Read `drVolAtrb` bit 8 on a gate's disk image before theorising about its
  ...
  `GISTPERSO-boot.vhd` — `CHANGELOG.md` 2026-08-06 (late night).
