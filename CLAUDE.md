...
| What changed and **why** — dated entries, the project's real design record | `CHANGELOG.md` (228 entries; **everything that happened to one subsystem** → `CHANGELOG_INDEX.md`, generated by `tools/changelog_index.py`) |
...
| **SWIM1** (IWM + ISM, 1.44 MB MFM) | `Swim1.h/.cpp` | ✓ `swim1_test`; ISM reads through the FluxPll separator (2026-08-14) | MAME SWIM |
