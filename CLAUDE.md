...
| What changed and **why** — dated entries, the project's real design record | `CHANGELOG.md` (229 entries; **everything that happened to one subsystem** → `CHANGELOG_INDEX.md`, generated by `tools/changelog_index.py`) |
...
- **206 CTest gates** (`ctest -N` 2026-08-14: 94 `unit`, 9 `smoke`, 29 `jit`,
...
ctest                        # 206 gates, ~4h (asset-dependent ones soft-skip)
